...
Hello! This program shows the educational level of a person based on their age. 
...
There are two options, singular command or series of commands for different OSes.
...
set -euo pipefail
javac src/main/java/xyz/whinyaan/dcit50/lab1/*.java -Xdiags:verbose
java -Dawt.useSystemAAFontSettings=lcd_hrgb -Dswing.aatext=true -cp src/main/java xyz.whinyaan.dcit50.lab1.App # set antialiasing to true for smooth font rendering
```
